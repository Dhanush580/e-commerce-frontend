    ...
    <div className="category-page">
      ...
      <section className="category-header">
        <div className="container">
          <h1 className="category-title">Necklaces Collection</h1>
      ...
      <div className="container">
        <SubcategoryCircles
          ...
          items={[
            { value: '', label: 'All', image: 'https://images.unsplash.com/photo-1605100804763-247f67b3557e?w=300&h=300&fit=crop' },
            ...
            <main className="products-main">
              ...
              <div className="results-header">
                <div className="results-info" style={{display:'flex',alignItems:'center',justifyContent:'space-between',gap:'12px',flexWrap:'wrap'}}>
                  <div>
                    <h2 style={{margin:0}}>Showing {getFilterStats().filtered} of {getFilterStats().total} necklaces</h2>
              ...
              {/* Products Grid */}
              {loading ? (
                <div className="loading-message">Loading necklaces...</div>
              ) : error ? (
